...
export const T = {
  ...
  parts: {
    ...
    lede: {
      en: "Every part that goes into the builds above is sold on its own too — new and used. Prices move with the market week to week, so they are not printed here; ask and you get today's number.",
      ar: "كل قطعة تدخل بالتجميعات الفوق تنباع لحالها هم — جديد ومستعمل. الأسعار تتغير حسب السوق أسبوع بأسبوع، علهيچ ما مكتوبة هنا؛ اسأل وتاخذ سعر اليوم.",
    },
    noPrice: { en: "Price not available", ar: "السعر غير متوفر" },
    ask: { en: "Ask about a part", ar: "اسأل عن قطعة" },
    askOne: { en: "Ask", ar: "اسأل" },
    inBuilds: { en: "In {n} builds", ar: "بـ {n} تجميعات" },
    inOne: { en: "In 1 build", ar: "بتجميعة وحدة" },
    inTwo: { en: "In 2 builds", ar: "بتجميعتين" },
    inMany: { en: "In {n} builds", ar: "بـ {n} تجميعة" },
