...
/* The parts counter. Nothing here is stock the shop was never seen fitting:
   ...
   `shot` names the photograph: one per family, so a card is illustrative of
   the part rather than a photograph of the exact unit in the box. */
...
export const PARTS = [
  // ── graphics cards ────────────────────────────────────────
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 5080", shot: "gpu-nvidia",
    specs: ["16GB", "GDDR7"], from: ["RTX 5080"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 5070 Ti", shot: "gpu-nvidia",
    specs: ["16GB", "GDDR7"], from: ["RTX 5070 Ti"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 5070", shot: "gpu-nvidia",
    specs: ["12GB", "GDDR7"], from: ["RTX 5070"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 4070 SUPER", shot: "gpu-nvidia",
    specs: ["12GB", "GDDR6X"], from: ["RTX 4070 SUPER"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 5060 Ti", shot: "gpu-nvidia",
    specs: ["16GB", "GDDR7"], from: ["RTX 5060 Ti 16GB"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 5060", shot: "gpu-nvidia",
    specs: ["8GB", "GDDR7"], from: ["RTX 5060"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 4060", shot: "gpu-nvidia",
    specs: ["8GB", "GDDR6"], from: ["RTX 4060 8GB"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 3070 Ti", shot: "gpu-nvidia",
    specs: ["8GB", "GDDR6X"], from: ["RTX 3070 Ti"] },
  { cat: "gpu", brand: "NVIDIA", name: "GeForce RTX 2060", shot: "gpu-nvidia",
    specs: ["12GB", "GDDR6"], from: ["RTX 2060 12GB"] },
  { cat: "gpu", brand: "AMD", name: "Radeon RX 9060 XT", shot: "gpu-amd",
    specs: ["16GB / 8GB", "GDDR6"], from: ["RX 9060 XT 16GB", "RX 9060 XT", "RX 9060 XT 8GB"] },

  // ── processors ────────────────────────────────────────────
  { cat: "cpu", brand: "AMD", name: "Ryzen 7 9800X3D", shot: "cpu-amd",
    specs: ["8C / 16T", "AM5", "3D V-Cache"], from: ["Ryzen 7 9800X3D"] },
  { cat: "cpu", brand: "AMD", name: "Ryzen 7 7800X3D", shot: "cpu-amd",
    specs: ["8C / 16T", "AM5", "3D V-Cache"], from: ["Ryzen 7 7800X3D"] },
  { cat: "cpu", brand: "AMD", name: "Ryzen 5 7600X", shot: "cpu-amd",
    specs: ["6C / 12T", "AM5"], from: ["Ryzen 5 7600X"] },
  { cat: "cpu", brand: "AMD", name: "Ryzen 7 5800X", shot: "cpu-amd",
    specs: ["8C / 16T", "AM4"], from: ["Ryzen 7 5800X"] },
  { cat: "cpu", brand: "AMD", name: "Ryzen 7 5700X", shot: "cpu-amd",
    specs: ["8C / 16T", "AM4"], from: ["Ryzen 7 5700X"] },
  { cat: "cpu", brand: "AMD", name: "Ryzen 5 5600X", shot: "cpu-amd",
    specs: ["6C / 12T", "AM4"], from: ["Ryzen 5 5600X"] },
  { cat: "cpu", brand: "AMD", name: "Ryzen 5 5500", shot: "cpu-amd",
    specs: ["6C / 12T", "AM4"], from: ["Ryzen 5 5500"] },
  { cat: "cpu", brand: "Intel", name: "Core i5 14400F", shot: "cpu-intel",
    specs: ["10C / 16T", "LGA 1700"], from: ["Intel Core i5 14400F"] },
  { cat: "cpu", brand: "Intel", name: "Core i5 12400F", shot: "cpu-intel",
    specs: ["6C / 12T", "LGA 1700"], from: ["Intel Core i5 12400F"] },

  // ── motherboards ──────────────────────────────────────────
  { cat: "mb", brand: "AMD", name: "B850", shot: "board", specs: ["AM5", "DDR5"], from: ["B850"] },
  { cat: "mb", brand: "AMD", name: "B650 WiFi", shot: "board", specs: ["AM5", "DDR5", "Wi-Fi"], from: ["B650 WiFi"] },
  { cat: "mb", brand: "AMD", name: "B650", shot: "board", specs: ["AM5", "DDR5"], from: ["B650"] },
  { cat: "mb", brand: "AMD", name: "B550", shot: "board", specs: ["AM4", "DDR4"], from: ["B550"] },
  { cat: "mb", brand: "AMD", name: "B450", shot: "board", specs: ["AM4", "DDR4"], from: ["B450"] },
  { cat: "mb", brand: "Intel", name: "B760", shot: "board", specs: ["LGA 1700"], from: ["B760"] },
  { cat: "mb", brand: "Intel", name: "H610", shot: "board", specs: ["LGA 1700"], from: ["H610"] },

  // ── memory ────────────────────────────────────────────────
  { cat: "ram", brand: "DDR5", name: "32GB DDR5 RGB", shot: "ram",
    specs: ["32GB", "DDR5", "RGB"], from: ["32GB DDR5 RGB"] },
  { cat: "ram", brand: "DDR5", name: "16GB DDR5", shot: "ram",
    specs: ["16GB", "DDR5", "6200 / 5600MHz"], from: ["16GB DDR5 6200", "16GB DDR5", "16GB 5600MHz"] },
  { cat: "ram", brand: "DDR4", name: "16GB DDR4", shot: "ram", specs: ["16GB", "DDR4"], from: ["16GB DDR4"] },
  ...
  { cat: "ram", brand: "RAM", name: "32GB", shot: "ram", specs: ["32GB"], from: ["32GB"] },
  { cat: "ram", brand: "RAM", name: "16GB RGB", shot: "ram", specs: ["16GB", "RGB"], from: ["16GB RGB"] },
  { cat: "ram", brand: "RAM", name: "16GB", shot: "ram", specs: ["16GB"], from: ["16GB"] },

  // ── storage ───────────────────────────────────────────────
  { cat: "ssd", brand: "NVMe", name: "M.2 NVMe 1TB", shot: "ssd",
    specs: ["1TB", "NVMe", "M.2"], from: ["M.2 1TB", "M.2 1TB NVMe"] },
  { cat: "ssd", brand: "NVMe", name: "M.2 NVMe 512GB", shot: "ssd",
    specs: ["512GB", "NVMe", "M.2"], from: ["512GB NVMe"] },
  { cat: "ssd", brand: "SSD", name: "SSD 1TB", shot: "ssd-sata", specs: ["1TB", "SSD"], from: ["SSD 1TB"] },
  { cat: "ssd", brand: "SSD", name: "SSD 500GB", shot: "ssd-sata", specs: ["500GB", "SSD"], from: ["SSD 500GB"] },

  // ── power supplies ────────────────────────────────────────
  { cat: "psu", brand: "PSU", name: "850W 80+ Gold", shot: "psu", specs: ["850W", "80+ Gold"], from: ["850W Gold"] },
  { cat: "psu", brand: "PSU", name: "850W", shot: "psu", specs: ["850W"], from: ["850W"] },
  { cat: "psu", brand: "PSU", name: "750W", shot: "psu", specs: ["750W"], from: ["750W"] },
  { cat: "psu", brand: "PSU", name: "600W", shot: "psu", specs: ["600W"], from: ["600W"] },

  // ── cooling and cases ─────────────────────────────────────
  { cat: "cool", brand: "AIO", name: "360mm liquid cooler", shot: "cooler",
    specs: ["360mm", "AIO"], from: ["360mm liquid"] },
  { cat: "cool", brand: "Case", name: "7-fan case", shot: "cooler",
